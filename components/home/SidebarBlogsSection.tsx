...
import { useTrendingBlogs } from "@/hooks/use-home-blogs";
        ...
        {trendingLoading ? (
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
            ...
            <button
              onClick={handleRetry}
              disabled={isRetrying}
              className="text-orange-600 hover:text-orange-700 text-sm font-medium flex items-center space-x-1 mx-auto disabled:opacity-50"
            >
              <RefreshCw
