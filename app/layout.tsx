...
export const metadata: Metadata = generateMetadata({
  ...
  description: "Official platform of Jagannath University Central Students' Union. Discover student leaders, read insightful articles, and engage with the vibrant campus community. Vote for your favorite candidates and stay updated with university news.",
...
export default function RootLayout({
  ...
  const organizationStructuredData = generateStructuredData({
    ...
    data: {
      ...
      description: "The official central students' union of Jagannath University, representing student interests and fostering campus leadership.",
      foundingDate: "1968",
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'BD',
