...
export const metadata: Metadata = generateMetadata({
  ...
  keywords: combineKeywords(KEYWORDS.general, KEYWORDS.candidates, KEYWORDS.leadership, ["candidate profiles", "student election", "university politics", "candidate manifestos", "student representatives"]),
  type: "website",
  url: "/candidates",
});
...
export default function CandidatesPage() {
  ...
  return (
    <>
      {/* Structured Data */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(candidatesStructuredData) }} />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 max-w-2xl">Meet the student candidates running for positions at Jagannath University. Vote for your favorites and engage with their profiles.</p>
          </div>
          ...
          <div className="text-center mt-8">
            <button className="bg-white border border-gray-300 hover:border-gray-400 text-gray-700 px-6 py-2 rounded-lg transition-colors">Load More Candidates</button>
          </div>
        </div>
