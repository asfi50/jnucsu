...
export default function SettingsPage() {
  ...
  const { userProfile, loading: isLoading, isAuthenticated } = useAuth();
  ...
  const profileLink = `https://jnucsu.com/candidates/${userProfile?.id}`;
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm sm:text-base">
                    Here&apos;s what&apos;s happening with your leadership
                    profile today.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <button className="p-4 border border-gray-200 rounded-lg hover:border-orange-300 hover:bg-orange-50 transition-colors text-left">
                  ...
                  <p className="text-sm text-gray-600">
                    Edit your information and photo
                  </p>
                </button>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Get notified when someone comments on your candidate page
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer ml-4">
                    <input
                      ...
                      onChange={(e) => {
                        const newSettings = {
                          ...notificationSettings,
                          candidateComments: e.target.checked,
                        };
                        setNotificationSettings(newSettings);
                        updateSettings(newSettings);
                      }}
                  ...
                  <label className="relative inline-flex items-center cursor-pointer ml-4">
                    <input
                      ...
                      onChange={(e) => {
                        const newSettings = {
                          ...notificationSettings,
                          messageReplies: e.target.checked,
                        };
                        setNotificationSettings(newSettings);
                        updateSettings(newSettings);
                      }}
